    ...
    if random_case==1:
        while (True):
            ...
            try:
                ...
                sql = "INSERT INTO datademo (img_husband ,img_wife , img_root1 ,img_root2 , image_ketqua, thongtin_sk) VALUES (%s, %s , %s ,%s ,%s )"
                ...
                if choose_case == 1:
                    ...
                    item1SuKien["loaddata6"] = f'{progress_bar}'
                    ...
                    item1SuKien["loaddata7"] = f'{progress_bar}'
                    ...
                    item1SuKien["loaddata8"] = f'{progress_bar}'

                    progress_bar.update(9)
                    item1SuKien["loaddata9"] = f'{progress_bar}'
                    ...
                    item1SuKien["loaddata91=finish"] = f'{progress_bar}'
                    progress_bar.close()
        ...
        try:
            ...
            val = (list_return_data[0]["thongtin"], list_return_data[1]["thongtin"],list_return_data[2]["thongtin"],list_return_data[3]["thongtin"],list_return_data[4]["thongtin"] , list_return_data[5]["thongtin"])
            mycursor.execute(sql, val)
            result1 = mycursor.fetchall()
